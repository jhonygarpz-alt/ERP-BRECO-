...
const REPORTES: ReporteInfo[] = [
  ...
  { numero: 3, titulo: 'Salidas Diarias con Importes', icon: CalendarClock, color: '#f59e0b', to: '/trafico/reportes/salidas-diarias' },
  { numero: 4, titulo: 'Combustible Conciliado', icon: Fuel, color: '#ef4444', to: '/trafico/reportes/combustible-conciliado' },
  { numero: 5, titulo: 'Ingresos Generados por Unidad', icon: BarChart3, color: '#f97316', to: '/trafico/reportes/ingresos-unidad' },
  ...
  { numero: 13, titulo: 'Cartas Porte a Revision', icon: FileWarning, color: '#8992a6', to: '/trafico/reportes/cartas-porte-revision' },
  ...
  { numero: 16, titulo: 'Listado de Viajes Concentrado', icon: ListOrdered, color: '#8b5cf6', to: '/trafico/reportes/viajes-concentrado' },
  { numero: 17, titulo: 'Vencimientos de Unidades', icon: AlertTriangle, color: '#f59e0b', to: '/trafico/reportes/vencimientos-unidades' },
  { numero: 18, titulo: 'Relacion de Viajes para Uso de Trafico', icon: ClipboardList, color: '#06b6d4', to: '/trafico/reportes/viajes-uso-trafico' },
  { numero: 19, titulo: 'Inventario de Equipo en Viajes', icon: Boxes, color: '#ec4899', to: '/trafico/reportes/inventario-equipo' },
  { numero: 20, titulo: 'Anticipos vs Gastos por Viaje/Trayecto', icon: Scale, color: '#8992a6', to: '/trafico/reportes/anticipos-vs-gastos' },
  { numero: 21, titulo: 'Just in Time Detallado', icon: Timer, color: '#3b82f6', to: '/trafico/reportes/just-in-time' },
  { numero: 22, titulo: 'Disponibilidad de Equipo', icon: Settings2, color: '#10b981', to: '/trafico/reportes/disponibilidad-equipo' },
  { numero: 23, titulo: 'Reporte de Operaciones', icon: FileSpreadsheet, color: '#f97316' },
  { numero: 24, titulo: 'Relacion de Viajes a Facturar', icon: PackageCheck, color: '#ef4444', to: '/trafico/reportes/pendientes-facturar' },
  { numero: 25, titulo: 'Resumen de Viajes por Estatus', icon: PieChart, color: '#8b5cf6', to: '/trafico/reportes/estatus-viajes' },
];
